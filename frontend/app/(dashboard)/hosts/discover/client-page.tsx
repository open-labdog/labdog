...
/** `embedded` drops the header: under `/discovery` it is the Scan tab. */
export default function DiscoverHostsPage({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      {!embedded && (
        <>
          <Breadcrumb items={[{ label: "Fleet", href: "/hosts" }, { label: "Discovery", href: "/discovery" }, { label: "Scan now" }]} />
          <div>
