...
summary see the [top-level README](https://gitlab.example.internal/operator/labdog/-/blob/dev/README.md).
...
[`backend/app/gitops/schema.py`](https://gitlab.example.internal/operator/labdog/-/blob/dev/backend/app/gitops/schema.py)
and is the source of truth. Per-module handlers are in
[`backend/app/gitops/importers/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/backend/app/gitops/importers/).
...
Pre-built packages are available on the [Releases](https://gitlab.example.internal/operator/labdog/-/releases) page for each tagged version.

**Debian / Ubuntu (.deb)**

```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/labdog/-/packages/generic/labdog/${VERSION}/labdog_${VERSION}-1_amd64.deb
...
```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/labdog/-/packages/generic/labdog/${VERSION}/labdog-${VERSION}-1.x86_64.rpm
...
```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/labdog/-/packages/generic/labdog/${VERSION}/labdog-${VERSION}-linux-amd64.tar.gz
...
```bash
curl -LO https://gitlab.example.com/operator/labdog/-/packages/generic/labdog/${VERSION}/SHA256SUMS
