...
summary see the [top-level README](https://gitlab.example.internal/operator/barricade/-/blob/dev/README.md).
...
[`backend/app/gitops/schema.py`](https://gitlab.example.internal/operator/barricade/-/blob/dev/backend/app/gitops/schema.py)
and is the source of truth. Per-module handlers are in
[`backend/app/gitops/importers/`](https://gitlab.example.internal/operator/barricade/-/tree/dev/backend/app/gitops/importers/).
...
Pre-built packages are available on the [Releases](https://gitlab.example.internal/operator/barricade/-/releases) page for each tagged version.

**Debian / Ubuntu (.deb)**

```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/barricade/-/packages/generic/barricade/${VERSION}/barricade_${VERSION}-1_amd64.deb
...
```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/barricade/-/packages/generic/barricade/${VERSION}/barricade-${VERSION}-1.x86_64.rpm
...
```bash
VERSION=0.0.1
curl -LO https://gitlab.example.com/operator/barricade/-/packages/generic/barricade/${VERSION}/barricade-${VERSION}-linux-amd64.tar.gz
...
```bash
curl -LO https://gitlab.example.com/operator/barricade/-/packages/generic/barricade/${VERSION}/SHA256SUMS
