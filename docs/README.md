...
| [ui/scheduled-actions.md](./ui/scheduled-actions.md) | Scheduled Actions — cron-driven runs of any action (built-in or pack-supplied) against hosts, groups, or the fleet |
