...
- [`minimal-pack/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/docs/examples/action-packs/minimal-pack) — smallest
  possible pack, one action with no parameters.
- [`reboot-pack/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/docs/examples/action-packs/reboot-pack) — a
  destructive action with a parameter, suitable as a template for
  things that modify host state.
- [`with-role/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/docs/examples/action-packs/with-role) — a pack that
...
[`backend/app/ansible/actions/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/backend/app/ansible/actions)
...
[`docs/examples/action-packs/with-verify/`](https://gitlab.example.internal/operator/labdog/-/tree/dev/docs/examples/action-packs/with-verify).

**Reusable verify templates** ship in the `labdog-playbooks` repo
under [`verify/`](https://gitlab.example.internal/operator/labdog-playbooks/-/tree/main/verify)
