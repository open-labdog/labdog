...
@celery_app.task(
    bind=True, name="app.tasks.resolver_sync.run_resolver_sync", queue="long_running"
)
    ...
    try:
        ...
        async def _run():
            async with task_session() as db:
                ...
                if not effective:
                    raise ValueError("No resolver config applies to this host")
                ...
                desired_state = effective.model_dump()
