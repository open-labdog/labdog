...
-A LABDOG-INPUT -s 192.0.2.0/28 -p tcp --dport 22 -m comment --comment "Managed by LabDog: Allow SSH" -j ACCEPT
...
"""
        ...
        assert ssh.direction == "input"
        assert ssh.source_cidr == "192.0.2.0/28"
    ...
    def test_parse_iptables_round_trip_with_renderer(self):
        ...
        rules = [
            FirewallRuleSpec(
                ...
                source_cidr="192.0.2.0/28", comment="Allow SSH",
            ),
